import "doc-editor-light/dist/styles/index.js"; // 注意引用样式
...
const example: BaseNode[] = [
      ...
      { children: [{ text: "支持引用块。" }], "quote-block-item": true },
      {
        ...
        children: [
          ...
          },
          {
            "quote-block-item": true,
            "unordered-list-item": { level: 1 },
            children: [{ text: "支持快捷键" }, { text: "> ", "inline-code": true }, { text: "。" }],
          },
        ],
      },
    ],
  ...
  {
    children: [{ text: "支持分割线，快捷键" }, { text: "--- ", "inline-code": true }, { text: "。" }],
  },
  ...
  },
  {
    ...
    children: [{ children: [{ text: "🏝 可以为高亮块更换主题。" }], "highlight-block-item": true }],
  },
  ...
  { children: [{ text: "支持快捷键: " }] },
  {
    ...
    children: [
      ...
      {
        "unordered-list-item": { level: 1 },
        children: [{ text: "多级有序列表" }, { text: "1. ", "inline-code": true }, { text: "，下级有序列表" }, { text: "tab", "inline-code": true }, { text: "。" }],
      },
      {
        "unordered-list-item": { level: 1 },
      ...
      {
        "unordered-list-item": { level: 1 },
        children: [{ text: "撤销" }, { text: "Ctrl + Z", "inline-code": true }, { text: "，前进" }, { text: "Ctrl + Shift + Z", "inline-code": true }, { text: "。" }],
      },
      {
        "unordered-list-item": { level: 1 },
...
export const SmartEditor: FC<{
  ...
  const { renderElement, renderLeaf, onKeyDown, onCopy, commands } = useMemo(() => {
    ...
    register.add(DocToolBarPlugin(editor, props.isRender, commands), ShortCutPlugin(editor, commands));
  ...
  return (
    <div>
      <Slate editor={editor} value={example}>
        ...
        <Editable renderElement={renderElement} renderLeaf={renderLeaf} readOnly={false} placeholder="Enter text ..." onKeyDown={onKeyDown} />
      </Slate>
    </div>
  );
};
